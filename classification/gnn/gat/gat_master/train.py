...
from utils import load_data, accuracy,processFeature2graph
...
print("adj is %s, features is %s, labels is %s, idx_train is %s , idx_val is %s , idx_test is %s"%(adj, features, labels, idx_train, idx_val, idx_test ))
#### Model and optimizer
assert False
if args.sparse:
